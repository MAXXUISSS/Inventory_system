...
func pickup_item():
	print("Intentando recoger el objeto...")
	var item = {
		"quantity" : 1,
		"type": item_type,
		"name": item_name,
	...
	if Global.player_node:
		if Global.add_item(item):
			...
			print("El objeto no pudo ser añadido al inventario")
	else:
		print("No se pudo obtener la referencia del jugador")
